...
#define PWM_PORT                    (AVR32_GPIO.port[PWMA_PORT_NUMBER])
...
//PB19 - MOTPWMA - J1-2
#define PWM_XL_PIN_NUMBER           AVR32_PWMA_0_PIN
#define PWM_XL                      (PWM_XL_PIN_NUMBER - PWM_PORT_NUMBER * 0x20)
#define PWM_XL_PWM_FUNCTION         AVR32_PWMA_0_FUNCTION
#define PWM_XL_PWM_CHANNEL          0

//PB20 - MOTPWMB -J1-3
#define PWM_YL_PIN_NUMBER           AVR32_PWMA_1_PIN
#define PWM_YL                      (PWM_YL_PIN_NUMBER - PWM_PORT_NUMBER * 0x20)
#define PWM_YL_PWM_FUNCTION         AVR32_PWMA_1_FUNCTION
#define PWM_YL_PWM_CHANNEL          1

//PB21 - MOTPWMC - J1-1
#define PWM_ZL_PIN_NUMBER           AVR32_PWMA_2_PIN
#define PWM_ZL                      (PWM_ZL_PIN_NUMBER - PWM_PORT_NUMBER * 0x20)
#define PWM_ZL_PWM_FUNCTION         AVR32_PWMA_2_FUNCTION
...
//PMSM defines
#define PMSMIA AVR32_ADCIFB_AD_0_PIN
#define PMSMIB AVR32_ADCIFB_AD_1_PIN
#define PMSMIC AVR32_ADCIFB_AD_2_PIN
...
#define CURRENT_IA_ADC_PIN          AVR32_ADCIFB_AD_0_PIN
#define CURRENT_IA_ADC_FUNCTION     AVR32_ADCIFB_AD_0_FUNCTION

// PA22
#define CURRENT_IB_ADC_CHANNEL      1
#define CURRENT_IB_ADC_PIN          AVR32_ADCIFB_AD_1_PIN
#define CURRENT_IB_ADC_FUNCTION     AVR32_ADCIFB_AD_1_FUNCTION

// PA23
#define CURRENT_IC_ADC_CHANNEL      2
#define CURRENT_IC_ADC_PIN          AVR32_ADCIFB_AD_2_PIN
#define CURRENT_IC_ADC_FUNCTION     AVR32_ADCIFB_AD_2_FUNCTION

//! @}

/* Connectors defines used during debug */
#define J4_10 AVR32_PIN_PA05
#define J13_11 AVR32_PIN_PA06
#define J13_12 AVR32_PIN_PA14
#define J13_13 AVR32_PIN_PA13

/* Connectors defines used during debug */
#define J4_1 AVR32_USART0_TXD_0_PIN
#define J4_2 AVR32_USART0_RXD_0_PIN

/* Usart definitions */
#define STDIO_USART               (&AVR32_USART0)
#define STDIO_USART_BAUDRATE      115200	//57600
#define STDIO_USART_RX_PIN        AVR32_USART0_RXD_0_PIN
#define STDIO_USART_RX_FUNCTION   AVR32_USART0_RXD_0_FUNCTION
#define STDIO_USART_TX_PIN        AVR32_USART0_TXD_0_PIN
#define STDIO_USART_TX_FUNCTION   AVR32_USART0_TXD_0_FUNCTION
