...
//PB20 - MOTPWMB -J1-3
#define PWM_YL_PIN_NUMBER           AVR32_PWM_2_PIN
#define PWM_YL                      (PWM_YL_PIN_NUMBER - PWM_PORT_NUMBER * 0x20)
#define PWM_YL_PWM_FUNCTION         AVR32_PWM_2_FUNCTION
#define PWM_YL_PWM_CHANNEL          1

//PB21 - MOTPWMC - J1-1
#define PWM_ZL_PIN_NUMBER           AVR32_PWM_0_PIN
#define PWM_ZL                      (PWM_ZL_PIN_NUMBER - PWM_PORT_NUMBER * 0x20)
#define PWM_ZL_PWM_FUNCTION         AVR32_PWM_0_FUNCTION
